...
namespace NetS.Core.Configuration
{
    ...
    {
        /// <summary>ApplicationHost command line arguments as a mapping of argument name to list of its values.</summary>
        private readonly Dictionary<string, List<string>> args;

        /// <summary>
        /// Initializes the instance of the object using command line arguments.
        /// </summary>
        /// <param name="args">ApplicationHost command line arguments.</param>
