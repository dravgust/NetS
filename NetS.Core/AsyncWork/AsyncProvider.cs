...
namespace NetS.Core.AsyncWork
{
    ...
    public partial class AsyncProvider : IAsyncProvider
    {
        ...
        public AsyncProvider(ILoggerFactory loggerFactory, ISignals signals, IApplicationLifeTime appLifetime)
        {
            ...
            this.appLifetime = Guard.NotNull(appLifetime, nameof(appLifetime));
        }
