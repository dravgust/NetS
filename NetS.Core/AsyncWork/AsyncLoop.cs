...
namespace NetS.Core.AsyncWork
{
    ...
    public class AsyncLoop : IAsyncLoop
    {
        ...
        /// <summary>
        /// ApplicationHost defined task that will be called and awaited in the async loop.
        ...
        /// <param name="loop">ApplicationHost defined task that will be called and awaited in the async loop.</param>
