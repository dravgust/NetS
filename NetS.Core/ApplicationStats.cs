...
namespace NetS.Core
{
    ...
    public class ApplicationStats : IApplicationStats
    {
        ...
        public ApplicationStats(IDateTimeProvider dateTimeProvider, ILoggerFactory loggerFactory)
        {
        ...
        public string GetStats()
        {
            ...
            lock (this.locker)
            {
                ...
                statsBuilder.AppendLine($"====== ApplicationHost stats ====== {date}");
